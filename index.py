...
banner = """
******************************* BombCrypto Bot **********************************
1   010101010101 010101010101 010101010101 0101   10101 010101010101
1   010101010101 010101010101 010101010101 0101   10101 010101010101
1       0101     0101             0101     010101010101        0101
1       0101     0101             0101     010101010101    0101
1 0101  0101     0101             0101     0101 10 0101  0101 
1 0101  0101     0101             0101     0101    0101 0101
1 0101010101     010101010101     0101     0101    0101 010101010101
1 0101010101     010101010101     0101     0101    0101 010101010101
*********************************************************************************
*********************************************************************************
...
if telegramIntegration == True:
    ...
    try:
        ...
        def send_telegram_invite(update: Update, context: CallbackContext) -> None:
            update.message.reply_text(
                f'💖 Join us on BCBOT Telegram group: https://t.me/+bTgiNX-78khkZDhh')

        def send_stop(update: Update, context: CallbackContext) -> None:
            logger('Desligando o bot...', telegram=True, emoji='🛑')
            os._exit(0)
...
def main():
    ...
    logger('Iniciando bot...', telegram=True, emoji='🤖')
    logger('Commands: \n\n /print \n /map \n /bcoin \n /invite \n /id \n /donation \n /pix \n\n /stop - Stop bot', telegram=True, emoji='ℹ️')
    logger('Agradeça o Jctmz o/.', telegram=True, emoji='💡')
...
if __name__ == '__main__':
    try:
        ...
        logger('Bot: Bye bye', telegram=True, emoji='😓')
        if(updater):
            updater.stop()
        exit()
